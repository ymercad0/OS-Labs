...
/* Lab 5 */
int total_tckts; /*sum of all tickets*/
int cont_wins; /* winning process count with tickets > 10*/
/* Generate random int*/
...
//   */
  ...
  struct proc *tail;
  rp = tail = rdy_head[q];
  while(tail->p_nextready != NULL) tail = tail->p_nextready; // get the tail
